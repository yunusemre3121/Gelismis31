...
.setDescription(`
${entry.executor} üyesi izinsiz emoji güncelledi, emojiyi eski haline getirdim.
─────────────────────
...
let oziGuardLog = await newEmoji.guild.channels.cache.find(x => x.name == "guard_log").send({ embeds: [ozi] });
