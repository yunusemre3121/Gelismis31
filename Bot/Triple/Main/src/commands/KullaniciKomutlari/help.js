...
module.exports = {
  ...
  run: async (client, message, args, embed, prefix) => {
    ...
    ${cyronixTik} Belirttiğin komuta ait bilgiler aşağıda verilmiştir!
