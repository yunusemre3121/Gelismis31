...
module.exports = {
  ...
  run: async (client, message, args, embed) => {
    ...
    if (userTasks.length === 0) {
      return message.reply("Aktif görev bulunamadı!").then((e) => setTimeout(() => { e.delete(); }, 10000));
    }
    ...
    message.reply("Tüm aktif görevleriniz başarıyla silindi!").then((e) => setTimeout(() => { e.delete(); }, 10000));
  }
};
