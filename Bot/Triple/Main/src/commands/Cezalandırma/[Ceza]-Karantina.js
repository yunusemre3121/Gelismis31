...
module.exports = {
  conf: {
    aliases: ["karantina"],
    name: "karantina",
    help: "karantina <cyr0nix/ID> <Sebep>",
  ...
  run: async (client, message, args, embed) => {
    ...
    message.reply({ content :`${cyronixTik} ${member.toString()} üyesi, ${message.author} tarafından, \`${reason}\` nedeniyle jaillendi! \`(Ceza ID: #${penal.id})\``}).then((e) => setTimeout(() => { e.delete(); }, 50000));
