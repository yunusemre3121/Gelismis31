...
module.exports = {
  ...
  run: async (client, message, args) => {  
    ...
    .setDescription(`${message.author} Kanal Kilidini Aktifleştirmek ve Deaktifleştirmek için butonları kullanınız. Gereksiz kullanımda cyr0nix ile görüşmeniz sorun yaratabilir.`)
