...
const CategoryChannels = require("../../../../../Shields/src/Models/CategoryChannels");
const TextChannels = require("../../../../../Shields/src/Models/TextChannels");
const VoiceChannels = require("../../../../../Shields/src/Models/VoiceChannels");
const RoleModel = require("../../../../../Shields/src/Models/Role");
const allah = require("../../../../../../config.json");
const moment = require("moment");
require("moment-duration-format");
const client = global.bot;
const Bots = require("../../../../../Shields/Backup")
  ...
  async execute(interaction, bot) {
   if(!allah.owners.includes(interaction.user.id)) {
      return interaction.reply({ content: ":x: Bot developerı olmadığın için kullanamazsın.", ephemeral: true })
       ...
       const ozi = interaction.options.getString("kategori");
